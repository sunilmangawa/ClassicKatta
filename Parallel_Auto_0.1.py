...
sql = "INSERT INTO kattaTable (kattaNo, fillTime, machineONtime, kattaDate) VALUES (%s, %s, %s, %s)"
...
def katta_counter():
    ...
    time_taken=0
    try:
        global machine_start, katta_Date, curA, sql
        while True:
            if btn_katta_fill.is_pressed:
                ...
                sleep(.1)
                val = (counted_bag, time_taken, machine_start, katta_Date)
